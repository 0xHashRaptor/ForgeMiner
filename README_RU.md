...
- 🆕 **v1.0.8** — **намного быстрее на перегруженных многокарточных ригах** (много карт на слабом CPU, несколько инстансов или медленные x1-райзеры): убрано пер-итерационное копирование на хост, душившее карты — **до +40–50%** на таких ригах. Хорошо укомплектованные риги и так работали на полную. Все поколения карт.
