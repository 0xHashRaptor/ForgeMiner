...
- 🆕 **v1.0.3** — RTX **20-я серия (Turing) теперь майнит на Stratum-пулах** (HeroMiners / LuckyPool / Kryptex), а не только AlphaPool; **+4%** на RTX 30 / 40 / 50 при том же разгоне и потреблении.
